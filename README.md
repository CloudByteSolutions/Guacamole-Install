...
- **A compatible OS:**
    ...
    - **Official vendor cloud images equivalent to the above versions.** 
      - (if your cloud image uses an IP of 127.0.1.1, [see here to use TLS with Nginx](https://github.com/CloudByteSolutions/Guacamole-Install/issues/21))
...
<img src="https://github.githubassets.com/images/icons/emoji/key.png" width="23"> **Need help with Active Directory authentication?** Check [here](https://github.com/CloudByteSolutions/Guacamole-Install/blob/main/ACTIVE-DIRECTORY-HOW-TO.md).
...
- **For the DATABASE layer:** Find the included  `install-mysql-backend-only.sh` [here](https://github.com/CloudByteSolutions/Guacamole-Install/tree/main/guac-enterprise-build) to install a standalone instance of the Guacamole MySQL database for your backend.
